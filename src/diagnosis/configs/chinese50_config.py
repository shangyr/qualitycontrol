...
class Chinese50Config(object):
    ...
    def __init__(self, args):
        ...
        self.data_path = PROJECT_DIR + "data/chinese50-v2"
        ...
        self.relation_idx_path = os.path.join(self.data_path, "relations.txt")
        self.entity_embedding_path = os.path.join(self.data_path, "entities_embed_bert.pth")
        # self.kge_trainer = ''
